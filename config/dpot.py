...
def get_args():
    ...
    parser.add_argument('--channel_split', action='store_true', default=False)
    parser.add_argument('--train_paths', nargs='+', type=str, default=['ns2d_pda', 'ns2d_cond_pda'])
    parser.add_argument('--test_paths', nargs='+', type=str, default=['ns2d_pda', 'ns2d_cond_pda'])
    parser.add_argument('--resume_path', type=str, default='models/DPOT/model_Ti.pth')
    parser.add_argument('--ntrain_list', nargs='+', type=int, default=[40, 60])
