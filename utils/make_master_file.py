...
# name = 'ns_V1e-3_N5000_T50' # 其实和你的name = 'ns2d_fno_1e-3'是一样的
# DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/large/ns_V1e-3_N5000_T50_train.hdf5', 'test_path': '/data5/store1/xxy/DPOT/data/large/ns_V1e-3_N5000_T50_test.hdf5'}
...
name = 'ns2d_fno_1e-5'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data_processed/FNO/NavierStokes_V1e-5_N1200_T20_train.hdf5', 
                      'test_path': '/data5/store1/xxy/DPOT/data_processed/FNO/NavierStokes_V1e-5_N1200_T20_test.hdf5'}
DATASET_DICT[name]['train_size'] = 1000
DATASET_DICT[name]['test_size'] = 200
DATASET_DICT[name]['scatter_storage']= False
DATASET_DICT[name]['t_test'] = 10   ## predict 10 timesteps for testing
...
name = 'ns2d_fno_1e-4'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/large/ns2d_1e-4_train.hdf5', 'test_path': '/data5/store1/xxy/DPOT/data/large/ns2d_1e-4_test.hdf5'}
...
name = 'ns2d_fno_1e-3'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/large/ns2d_1e-3_train.hdf5', 'test_path': '/data5/store1/xxy/DPOT/data/large/ns2d_1e-3_test.hdf5'}
DATASET_DICT[name]['train_size'] = 1000
DATASET_DICT[name]['test_size'] = 200
DATASET_DICT[name]['scatter_storage'] = False
DATASET_DICT[name]['t_test'] = 20   ## predict 10 timesteps for testing
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-1_zeta1e-1/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-1_zeta1e-1/test'}
...
# DATASET_DICT[name] = {'train_path': './data/large/ns2d_pdb_M1_eta1e-2_zeta1e-2_train.hdf5', 'test_path': './data/large/ns2d_pdb_M1_eta1e-2_zeta1e-2_test.hdf5'}
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-2_zeta1e-2/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-2_zeta1e-2/test'}
# DATASET_DICT[name] = {'train_path': '/datasets/opb/pretrain/ns2d_pdb_M1_eta1e-2_zeta1e-2/train', 'test_path': '/datasets/opb/pretrain/ns2d_pdb_M1_eta1e-2_zeta1e-2/test'}
DATASET_DICT[name]['train_size'] = 9000
DATASET_DICT[name]['test_size'] = 200       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-1_zeta1e-1/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-1_zeta1e-1/test'}
DATASET_DICT[name]['train_size'] = 9000
DATASET_DICT[name]['test_size'] = 200       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 11   ## predict 10 timesteps for testing
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-2_zeta1e-2/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-2_zeta1e-2/test'}
DATASET_DICT[name]['train_size'] = 9000
DATASET_DICT[name]['test_size'] = 200       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 11   ## predict 10 timesteps for testing
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-8_zeta1e-8_turb_512/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-8_zeta1e-8_turb_512/test'}
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-8_zeta1e-8_turb_512/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-8_zeta1e-8_turb_512/test'}
DATASET_DICT[name]['train_size'] = 900
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-8_zeta1e-8_rand_512/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1e-1_eta1e-8_zeta1e-8_rand_512/test'}
DATASET_DICT[name]['train_size'] = 900
DATASET_DICT[name]['test_size'] = 20       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 11   ## predict 10 timesteps for testing
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-8_zeta1e-8_rand_512/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns2d_pdb_M1_eta1e-8_zeta1e-8_rand_512/test'}
DATASET_DICT[name]['train_size'] = 900
DATASET_DICT[name]['test_size'] = 20       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 11   ## predict 10 timesteps for testing
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns3d_pdb_M1_rand/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns3d_pdb_M1_rand/test'}
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns3d_pdb_M1e-1_rand/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns3d_pdb_M1e-1_rand/test'}
DATASET_DICT[name]['train_size'] = 90
DATASET_DICT[name]['test_size'] = 10       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 11   ## predict 10 timesteps for testing
...
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/ns3d_pdb_M1_turb/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/ns3d_pdb_M1_turb/test'}
...
name = 'swe_pdb'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/swe_pdb/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/swe_pdb/test'}
DATASET_DICT[name]['train_size'] = 900
DATASET_DICT[name]['test_size'] = 100       ### default 60, maximum 100
DATASET_DICT[name]['scatter_storage'] = True
...
name = 'dr_pdb'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/pdebench/dr_pdb/train', 'test_path': '/data5/store1/xxy/DPOT/data/pdebench/dr_pdb/test'}
DATASET_DICT[name]['train_size'] = 900
...
## 从这里开始是 CFD - Bench
name = 'cfdbench'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/cfdbench/ns2d_cdb_train.hdf5', 'test_path': '/data5/store1/xxy/DPOT/data/cfdbench/ns2d_cdb_test.hdf5'}
DATASET_DICT[name]['train_size'] = 9000
DATASET_DICT[name]['test_size'] = 1000       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = False
DATASET_DICT[name]['t_test'] = 20   ## predict 10 timesteps for testing
DATASET_DICT[name]['t_in'] = 10     ## use 10 as prefix steps, not necessary used
DATASET_DICT[name]['t_test_fix'] = 10   ## predict 10 timesteps for testing
DATASET_DICT[name]['t_total'] = 20
DATASET_DICT[name]['in_size'] = (64, 64)
...
name = 'ns2d_pda'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/DPOT/data/large/pdearena/ns2d_pda/train', 'test_path': '/data5/store1/xxy/DPOT/data/large/pdearena/ns2d_pda/test'}
...
name = 'sw2d_pda'
DATASET_DICT[name] = {'train_path': '/data3/store1/xxy/sw2d_pda/train', 'test_path': '/data3/store1/xxy/sw2d_pda/test'}
...
name = 'burgers'
DATASET_DICT[name] = {'train_path': '/data5/store1/xxy/Burgers/train', 'test_path': '/data5/store1/xxy/Burgers/test'}
DATASET_DICT[name]['train_size'] = 1000
DATASET_DICT[name]['test_size'] = 100       ### default 100, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 40   ## predict 10 timesteps for testing
DATASET_DICT[name]['t_in'] = 10     ## use 10 as prefix steps, not necessary used
DATASET_DICT[name]['t_total'] = 50
DATASET_DICT[name]['in_size'] = (128, 128)
DATASET_DICT[name]['n_channels'] = 1
